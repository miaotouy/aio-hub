              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "转写与语音", link: "/user-guide/tools/llm-chat/settings/transcription" },
                    { text: "全局正则", link: "/user-guide/tools/llm-chat/settings/regex-global" },
                    { text: "插件扩展", link: "/user-guide/tools/llm-chat/settings/plugins" },
                  ],
                },
