...
> 本文档是 `src/tools/` 下目前(2026-5-6)为止全部 34 个工具模块的架构速览花名册，按功能大类分组。
...
### 13. [asset-manager](../src/tools/asset-manager/ARCHITECTURE.md) — 中央资产管理中心
...
### 14. [content-deduplicator](../src/tools/content-deduplicator/ARCHITECTURE.md) — 内容查重工具
...
### 15. [data-filter](../src/tools/data-filter/ARCHITECTURE.md) — 数据筛选工具
...
### 16. [json-formatter](../src/tools/json-formatter/ARCHITECTURE.md) — JSON 格式化工具
...
### 17. [regex-applier](../src/tools/regex-applier/ARCHITECTURE.md) — 正则批量处理工具
...
### 18. [text-diff](../src/tools/text-diff/ARCHITECTURE.md) — 文本对比工具
...
### 19. [directory-tree](../src/tools/directory-tree/ARCHITECTURE.md) — 目录树可视化
...
### 20. [directory-janitor](../src/tools/directory-janitor/ARCHITECTURE.md) — 目录清理器
...
### 21. [symlink-mover](../src/tools/symlink-mover/ARCHITECTURE.md) — 符号链接搬家
...
### 22. [ffmpeg-tools](../src/tools/ffmpeg-tools/ARCHITECTURE.md) — FFmpeg 多媒体工作台
...
### 23. [media-info-reader](../src/tools/media-info-reader/ARCHITECTURE.md) — 媒体元数据读取
...
### 24. [danmaku-player](../src/tools/danmaku-player/ARCHITECTURE.md) — 弹幕播放器
...
### 25. [transcription](../src/tools/transcription/ARCHITECTURE.md) — 多模态转写管理
...
### 26. [smart-ocr](../src/tools/smart-ocr/ARCHITECTURE.md) — 智能 OCR
...
### 27. [web-canvas](../src/tools/web-canvas/ARCHITECTURE.md) — Agent 协作画布
...
### 28. [git-analyzer](../src/tools/git-analyzer/ARCHITECTURE.md) — Git 仓库分析
...
### 29. [web-distillery](../src/tools/web-distillery/ARCHITECTURE.md) — 网页蒸馏室
...
### 30. [vcp-connector](../src/tools/vcp-connector/ARCHITECTURE.md) — VCP 连接器
...
### 31. [color-picker](../src/tools/color-picker/ARCHITECTURE.md) — 智能取色器
...
### 32. [system-pulse](../src/tools/system-pulse/ARCHITECTURE.md) — 系统硬件监控仪表盘
...
### 33. [rich-text-renderer](../src/tools/rich-text-renderer/ARCHITECTURE.md) — 富文本渲染引擎 🔥
...
### 34. [st-worldbook-editor](../src/tools/st-worldbook-editor/ARCHITECTURE.md) — ST 世界书编辑器
...
|  13  | asset-manager        | [`src/tools/asset-manager/ARCHITECTURE.md`](../src/tools/asset-manager/ARCHITECTURE.md)               | 中央资产管理（Rust 索引 + 去重）                  |
|  14  | content-deduplicator | [`src/tools/content-deduplicator/ARCHITECTURE.md`](../src/tools/content-deduplicator/ARCHITECTURE.md) | 内容查重（五阶段扫描漏斗）                        |
|  15  | data-filter          | [`src/tools/data-filter/ARCHITECTURE.md`](../src/tools/data-filter/ARCHITECTURE.md)                   | JSON/YAML 数据筛选                                |
|  16  | json-formatter       | [`src/tools/json-formatter/ARCHITECTURE.md`](../src/tools/json-formatter/ARCHITECTURE.md)             | JSON 格式化（可控展开层级）                       |
|  17  | regex-applier        | [`src/tools/regex-applier/ARCHITECTURE.md`](../src/tools/regex-applier/ARCHITECTURE.md)               | 正则批量处理（前后端双引擎）                      |
|  18  | text-diff            | [`src/tools/text-diff/ARCHITECTURE.md`](../src/tools/text-diff/ARCHITECTURE.md)                       | 文本对比（Monaco Diff + Patch）                   |
|  19  | directory-tree       | [`src/tools/directory-tree/ARCHITECTURE.md`](../src/tools/directory-tree/ARCHITECTURE.md)             | 目录树可视化（Rust 遍历 + 前端渲染）              |
|  20  | directory-janitor    | [`src/tools/directory-janitor/ARCHITECTURE.md`](../src/tools/directory-janitor/ARCHITECTURE.md)       | 目录清理（Rust 扫描 + 回收站）                    |
|  21  | symlink-mover        | [`src/tools/symlink-mover/ARCHITECTURE.md`](../src/tools/symlink-mover/ARCHITECTURE.md)               | 符号链接搬家（双模式 + 安全校验）                 |
|  22  | ffmpeg-tools         | [`src/tools/ffmpeg-tools/ARCHITECTURE.md`](../src/tools/ffmpeg-tools/ARCHITECTURE.md)                 | FFmpeg 工作台（Tokio 异步进程）                   |
|  23  | media-info-reader    | [`src/tools/media-info-reader/ARCHITECTURE.md`](../src/tools/media-info-reader/ARCHITECTURE.md)       | 媒体元数据读取（三层解析）                        |
|  24  | danmaku-player       | [`src/tools/danmaku-player/ARCHITECTURE.md`](../src/tools/danmaku-player/ARCHITECTURE.md)             | 弹幕播放器（窗口吸附 + 虚拟时钟）                 |
|  25  | transcription        | [`src/tools/transcription/ARCHITECTURE.md`](../src/tools/transcription/ARCHITECTURE.md)               | 多模态转写（插件化引擎）                          |
|  26  | smart-ocr            | [`src/tools/smart-ocr/ARCHITECTURE.md`](../src/tools/smart-ocr/ARCHITECTURE.md)                       | 智能 OCR（四引擎 + 切图）                         |
|  27  | canvas               | [`src/tools/canvas/ARCHITECTURE.md`](../src/tools/canvas/ARCHITECTURE.md)                             | Agent 协作画布（Physical-First + Diff）           |
|  28  | git-analyzer         | [`src/tools/git-analyzer/ARCHITECTURE.md`](../src/tools/git-analyzer/ARCHITECTURE.md)                 | Git 仓库分析（git2-rs + 流式）                    |
|  29  | web-distillery       | [`src/tools/web-distillery/ARCHITECTURE.md`](../src/tools/web-distillery/ARCHITECTURE.md)             | 网页蒸馏（三层模态 + 本地代理）                   |
|  30  | vcp-connector        | [`src/tools/vcp-connector/ARCHITECTURE.md`](../src/tools/vcp-connector/ARCHITECTURE.md)               | VCP 连接器（监控 + 节点 + 桥接）                  |
|  31  | color-picker         | [`src/tools/color-picker/ARCHITECTURE.md`](../src/tools/color-picker/ARCHITECTURE.md)                 | 智能取色（三算法并行分析）                        |
|  32  | system-pulse         | [`src/tools/system-pulse/ARCHITECTURE.md`](../src/tools/system-pulse/ARCHITECTURE.md)                 | 系统硬件监控（推送式 + RingBuffer）               |
|  33  | rich-text-renderer   | [`src/tools/rich-text-renderer/ARCHITECTURE.md`](../src/tools/rich-text-renderer/ARCHITECTURE.md)     | 富文本渲染引擎（流式零闪烁）                      |
|  34  | st-worldbook-editor  | [`src/tools/st-worldbook-editor/ARCHITECTURE.md`](../src/tools/st-worldbook-editor/ARCHITECTURE.md)   | ST 世界书编辑器（轻量包装器）                     |

---

> 📅 生成时间: 2026-05-06
> 📁 文档来源: `src/tools/*/ARCHITECTURE.md`（34 篇架构文档汇总）
