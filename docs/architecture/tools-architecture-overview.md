...
> 本文档是 `src/tools/` 下目前(2026-5-17)为止全部 36 个工具模块的架构速览花名册，按功能大类分组。
...
### 29. [web-canvas](../src/tools/web-canvas/ARCHITECTURE.md) — Agent 协作画布
...
### 30. [git-analyzer](../src/tools/git-analyzer/ARCHITECTURE.md) — Git 仓库分析
...
### 31. [web-distillery](../src/tools/web-distillery/ARCHITECTURE.md) — 网页蒸馏室
...
### 32. [vcp-connector](../src/tools/vcp-connector/ARCHITECTURE.md) — VCP 连接器
...
### 33. [color-picker](../src/tools/color-picker/ARCHITECTURE.md) — 智能取色器
...
### 34. [system-pulse](../src/tools/system-pulse/ARCHITECTURE.md) — 系统硬件监控仪表盘
...
### 35. [rich-text-renderer](../src/tools/rich-text-renderer/ARCHITECTURE.md) — 富文本渲染引擎 🔥
...
### 36. [st-worldbook-editor](../src/tools/st-worldbook-editor/ARCHITECTURE.md) — ST 世界书编辑器
...
|  29  | web-canvas           | [`src/tools/web-canvas/ARCHITECTURE.md`](../src/tools/web-canvas/ARCHITECTURE.md)                     | Agent 协作画布（Physical-First + Diff）           |
|  30  | git-analyzer         | [`src/tools/git-analyzer/ARCHITECTURE.md`](../src/tools/git-analyzer/ARCHITECTURE.md)                 | Git 仓库分析（git2-rs + 流式）                    |
|  31  | web-distillery       | [`src/tools/web-distillery/ARCHITECTURE.md`](../src/tools/web-distillery/ARCHITECTURE.md)             | 网页蒸馏（三层模态 + 本地代理）                   |
|  32  | vcp-connector        | [`src/tools/vcp-connector/ARCHITECTURE.md`](../src/tools/vcp-connector/ARCHITECTURE.md)               | VCP 连接器（监控 + 节点 + 桥接）                  |
|  33  | color-picker         | [`src/tools/color-picker/ARCHITECTURE.md`](../src/tools/color-picker/ARCHITECTURE.md)                 | 智能取色（三算法并行分析）                        |
|  34  | system-pulse         | [`src/tools/system-pulse/ARCHITECTURE.md`](../src/tools/system-pulse/ARCHITECTURE.md)                 | 系统硬件监控（推送式 + RingBuffer）               |
|  35  | rich-text-renderer   | [`src/tools/rich-text-renderer/ARCHITECTURE.md`](../src/tools/rich-text-renderer/ARCHITECTURE.md)     | 富文本渲染引擎（流式零闪烁）                      |
|  36  | st-worldbook-editor  | [`src/tools/st-worldbook-editor/ARCHITECTURE.md`](../src/tools/st-worldbook-editor/ARCHITECTURE.md)   | ST 世界书编辑器（轻量包装器）                     |

---

> 📅 生成时间: 2026-05-17
> 📁 文档来源: `src/tools/*/ARCHITECTURE.md`（36 篇架构文档汇总）
