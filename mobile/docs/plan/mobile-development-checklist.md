...
- [ ] Android AVD 的资产预览和聊天附件工作流已于 2026-07-26 通过 APK 端到端回归；仍需在 AVD 与 Android 真机验证手势冲突、返回、方向、安全区、全屏 fallback、快速切换和资源回收，并按可用性结果迭代。
