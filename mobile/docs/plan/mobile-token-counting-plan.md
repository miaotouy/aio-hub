...
> 日期：2026-07-14
> 已实施消费架构见 [`llm-chat/ARCHITECTURE.md`](../../src/tools/llm-chat/ARCHITECTURE.md) 与 [`agent-manager/ARCHITECTURE.md`](../../src/tools/agent-manager/ARCHITECTURE.md)；本文只继续维护设备性能和 iOS 验证门禁。
