  ...
  <div class="asset-manager-view" data-testid="asset-manager-view">
    ...
    <main class="page-content">
      <template v-if="library.mode.value === 'assets'">
        ...
        <div
          v-else-if="!library.assets.value.length"
          class="state-panel"
    ...
    <div
      ...
      class="selection-bar"
      role="toolbar"
      data-testid="asset-selection-bar"
    >
