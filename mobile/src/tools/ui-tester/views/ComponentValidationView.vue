...
const beginComponentObservation = () => {
  createManualRun("components", "component-layout-observation", {
    viewportWidth: window.innerWidth,
  });
};

const finishComponentObservation = (verdict: "passed" | "failed") => {
  if (componentPending.value) {
    setManualObservation(componentPending.value.id, verdict);
  }
};
...
<template>
  <div class="component-validation-view keyboard-aware-scroll">
    <ValidationRunHeader
      :passed="componentTotals.passed"
      :failed="componentTotals.failed"
      :pending="componentTotals.pending"
    />
