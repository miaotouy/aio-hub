...
Function PageReinstall
  ...
  ${Else}
    ...
    ; Select the non-destructive install option by default.
    ; For a same-version reinstall, the first option is the direct reinstall.
    ; For upgrades and downgrades, the second option installs without first
