...
pub fn register_commands(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        crate::recall::recall_update_entry_vector,
        crate::recall::recall_clear_legacy_vectors,
        crate::recall::recall_clear_all_other_vectors,
        crate::recall::recall_get_embedding_cache,
        crate::recall::recall_set_embedding_cache,
        crate::recall::recall_clear_embedding_cache,
        crate::recall::recall_retrieval_cache_get,
        ...
        crate::recall::recall_flush_all_tag_pools,
        crate::recall::recall_clone_base,
        crate::recall::recall_export_base,
        crate::recall::recall_export_backup,
        crate::recall::recall_export_backups,
        crate::recall::recall_cancel_backup_operation,
        ...
        crate::knowledge::knowledge_enqueue_paths,
        crate::knowledge::knowledge_list_sources,
        crate::knowledge::knowledge_list_ingest_tasks,
        crate::knowledge::knowledge_claim_ingest_task,
        ...
        crate::knowledge::knowledge_switch_embedding_route,
