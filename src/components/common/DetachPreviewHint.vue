...
.preview-hint {
  ...
  top: 24px;
  left: 24px;
  z-index: 100000; /* 比 TitleBar 的 9999 更高 */
  pointer-events: none;
...
.preview-hint.can-detach .hint-content {
  ...
  box-shadow:
    0 4px 16px color-mix(in srgb, var(--success-color) 20%, transparent),
...
.preview-hint.cannot-detach .hint-content {
  ...
  box-shadow:
    0 4px 16px color-mix(in srgb, var(--warning-color) 15%, transparent),
...
@keyframes gentleGlow {
  ...
  50% {
    box-shadow:
      0 6px 24px color-mix(in srgb, var(--success-color) 30%, transparent),
