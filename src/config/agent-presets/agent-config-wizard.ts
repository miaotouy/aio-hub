...
<div style="display: flex; gap: 8px; flex-wrap: wrap; margin-top: 12px;">
  ...
  toolCallConfig: {
    ...
    autoApproveMethods: {
      // 只读方法自动批准
      "llm-chat-agent-mgmt_list_agents": true,
      "llm-chat-agent-mgmt_search_agents": true,
      "llm-chat-agent-mgmt_read_agent_config": true,
      "llm-chat-agent-mgmt_export_agent_as_text": true,
      // 写入方法需要用户确认
      "llm-chat-agent-mgmt_set_agent_field": false,
      "llm-chat-agent-mgmt_find_replace_in_presets": false,
      "llm-chat-agent-mgmt_add_preset_message": false,
      "llm-chat-agent-mgmt_delete_preset_message": false,
      "llm-chat-agent-mgmt_move_preset_message": false,
      "llm-chat-agent-mgmt_import_agent_from_text": false,
    },
