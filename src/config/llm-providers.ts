    ...
    defaultModels: [
      {
        ...
        provider: "cohere",
        capabilities: { toolUse: true },
        description: "企业推理旗舰，复杂逻辑分析，256K上下文",
      },
      {
        id: "command-a-vision",
      ...
      },
      {
        ...
        provider: "cohere",
        capabilities: { toolUse: true },
        description: "专业翻译模型，100+语言支持，企业级精准度",
      },
      {
        id: "command-a-code",
        name: "Command A Code",
      ...
      },
      {
        ...
        provider: "cohere",
        capabilities: { toolUse: true },
        description: "稳定版Command R，生产环境优选",
      },
      {
        id: "command-r",
        name: "Command R",
  ...
  // Google Vertex AI
  {
    ...
    defaultModels: [
      ...
      },
      {
        ...
        provider: "google",
        capabilities: { vision: true, toolUse: true },
        description: "计算机使用专用，浏览器/移动任务自动化",
      },
      {
        id: "gemini-1.5-pro",
        name: "Gemini 1.5 Pro",
