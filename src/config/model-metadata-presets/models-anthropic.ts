  ...
  [
    // === Claude 当前具体模型信息（官方模型页/价格页，2026-06） ===
    {
      ...
      properties: {
        ...
        description:
          "Claude Fable 5 / 5.1：Anthropic 面向长程 agent 的下一代智能模型，1M 上下文，128K 输出，自适应思考始终开启",
      },
      priority: 36,
      enabled: true,
      description: "模型正则 claude-fable-5(?:-1)? 元数据规则",
    },
    {
    ...
    },
    {
      ...
      properties: {
        ...
        description: "Claude 3.x Sonnet（已退役，原生支持视觉与扩展思考）",
      },
      priority: 25,
      enabled: true,
    ...
    },
    {
      ...
      properties: {
        ...
        deprecated: true,
        retirementDate: "2026-02-19",
        description: "Claude 3.x 系列模型（已退役）",
      },
      priority: 25,
      enabled: true,
