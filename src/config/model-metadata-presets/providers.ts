...
export const providerRules: LegacyModelMetadataRule<ModelMetadataProperties>[] =
  [
    ...
    {
      id: "provider-microsoft-ai",
      matchType: "provider",
      matchValue: "microsoft-ai",
      properties: {
        icon: `/model-icons/microsoft-color.svg`,
        group: "Microsoft AI",
      },
      priority: 10,
      enabled: true,
      description: "Microsoft AI 提供商图标",
    },
    {
      id: "provider-xai",
      matchType: "provider",
    ...
    },
    {
      ...
      priority: 10,
      enabled: true,
      description: "Reve 提供商图标",
    },
    {
      id: "provider-ideogram",
      matchType: "provider",
      matchValue: "ideogram",
      properties: {
