...
import { KNOWLEDGE_MIGRATION_CONTRIBUTION_ID } from "../types";
import MigrationStep from "../components/MigrationStep.vue";

const context: UpgradeFlowContext = {
  mode: "automatic",
  currentVersion: "0.7.0-alpha.1",
  releaseVersions: ["0.7.0-alpha.1"],
  primaryReleaseVersion: "0.7.0-alpha.1",
  transition: "upgrade",
  contributions: {
    [KNOWLEDGE_MIGRATION_CONTRIBUTION_ID]: {
      instanceKey: "migration:fingerprint",
