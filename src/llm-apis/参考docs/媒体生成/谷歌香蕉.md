...
Nano Banana is the name for Gemini's native image generation model series. Gemini can generate, edit, and process images conversationally with text, images, or a combination of both. This lets you create, edit, and iterate on visuals with unprecedented control.
