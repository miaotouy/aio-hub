...
export const presets: ApiPreset[] = [
  ...
  },
  {
    ...
    variables: [
      ...
      },
      {
        ...
        type: "string",
        label: "模型",
        placeholder: "例如: gpt-4o、deepseek-chat、glm-4-plus",
        required: true,
        description: "LLM 模型名称，可直接输入兼容接口的模型 ID",
      },
      {
        key: "userMessage",
  ...
  },
  {
    ...
    description:
      "Google Gemini 的生成内容 API（流式时需手动将端点改为 streamGenerateContent）",
    urlTemplate:
    ...
    variables: [
      ...
      },
      {
        ...
        required: true,
        description: "Gemini 模型名称，可直接输入模型 ID",
      },
      {
        key: "userMessage",
        value: "Hello, how are you?",
  ...
  },
  {
    ...
    variables: [
      ...
      },
      {
        ...
        required: true,
        description: "Claude 模型名称，可直接输入模型 ID",
      },
      {
        key: "userMessage",
        value: "Hello, how are you?",
