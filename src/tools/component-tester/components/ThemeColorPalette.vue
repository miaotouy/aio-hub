      ...
      <div class="color-category">
        ...
        <div class="color-row">
          ...
          <div v-for="i in 9" :key="i" class="color-card">
            <div
              class="color-preview"
              :style="{ backgroundColor: colors[`primaryLight${i}`] }"
            ></div>
            <div class="color-info">
      ...
      <div class="color-category">
        ...
        <div class="color-row">
          ...
          <div v-for="i in 9" :key="i" class="color-card">
            <div
              class="color-preview"
              :style="{ backgroundColor: colors[`successLight${i}`] }"
            ></div>
            <div class="color-info">
              <div class="color-name">Light {{ i }}</div>
      ...
      <div class="color-category">
        ...
        <div class="color-row">
          ...
          <div v-for="i in 9" :key="i" class="color-card">
            <div
              class="color-preview"
              :style="{ backgroundColor: colors[`warningLight${i}`] }"
            ></div>
            <div class="color-info">
              <div class="color-name">Light {{ i }}</div>
      ...
      <div class="color-category">
        ...
        <div class="color-row">
          ...
          <div v-for="i in 9" :key="i" class="color-card">
            <div
              class="color-preview"
              :style="{ backgroundColor: colors[`dangerLight${i}`] }"
            ></div>
            <div class="color-info">
              <div class="color-name">Light {{ i }}</div>
      ...
      <div class="color-category">
        ...
        <div class="color-row">
          ...
          <div v-for="i in 9" :key="i" class="color-card">
            <div
              class="color-preview"
              :style="{ backgroundColor: colors[`infoLight${i}`] }"
            ></div>
            <div class="color-info">
              <div class="color-name">Light {{ i }}</div>
    ...
    <div class="section">
      ...
      <div class="color-grid">
        ...
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.textRegular }"
          ></div>
          <div class="color-info">
        ...
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.textPlaceholder }"
          ></div>
          <div class="color-info">
    ...
    <div class="section">
      ...
      <div class="color-grid">
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.borderDarker }"
          ></div>
          <div class="color-info">
        ...
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.borderLighter }"
          ></div>
          <div class="color-info">
    ...
    <div class="section">
      ...
      <div class="color-grid">
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.fillDarker }"
          ></div>
          <div class="color-info">
            <div class="color-name">Darker</div>
        ...
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.fillDark }"
          ></div>
          <div class="color-info">
            <div class="color-name">Dark</div>
        ...
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.fillLight }"
          ></div>
          <div class="color-info">
            <div class="color-name">Light</div>
        ...
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.fillLighter }"
          ></div>
          <div class="color-info">
            <div class="color-name">Lighter</div>
    ...
    <div class="section">
      ...
      <div class="color-grid">
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.mask }"
          ></div>
          <div class="color-info">
        ...
        <div class="color-card">
          <div
            class="color-preview"
            :style="{ backgroundColor: colors.maskExtra }"
          ></div>
          <div class="color-info">
...
const loadColors = () => {
  const loadColorFamily = (
    name: "primary" | "success" | "warning" | "danger" | "info"
  ) => {
