      ...
      methods: [
        {
          ...
          displayName: "搜索条目",
          description:
            "在知识库中搜索条目。支持关键词或向量搜索。结果包含 index 序号方便后续操作引用。",
          agentCallable: true,
          parameters: [
            {
              name: "kbNames",
        ...
        },
        {
          ...
          displayName: "创建或更新条目",
          description:
            "创建新条目或更新已存在条目的完整内容。推荐使用 kbName 定位知识库。",
          agentCallable: true,
          parameters: [
            {
              name: "kbName",
              type: "string",
              description: "知识库名称 (推荐)",
              required: false,
            },
            {
              name: "kbId",
      ...
      methods: [
        {
          ...
          displayName: "列出知识库列表",
          description:
            "列出所有知识库及其基本信息和统计数据。支持名称搜索和统计信息开关。",
          agentCallable: true,
          parameters: [
            {
              name: "query",
              type: "string",
              description: "知识库名称关键词搜索（模糊匹配）",
              required: false,
            },
            {
              name: "includeStats",
