        ...
        },
        {
          ...
          parameters: [
            ...
            },
            {
              name: "libraryIds",
              type: "string[]",
              description: "稳定资料库 ID；省略时遵守 allowSearchAll",
              required: false,
            },
            {
              name: "maxRounds",
              type: "number",
              description: "最大研究轮次，1 到 8",
              required: false,
              defaultValue: 3,
            },
            {
              name: "maxToolCalls",
              type: "number",
              description: "最大 search/read 调用数，1 到 40",
              required: false,
              defaultValue: 12,
            },
            {
              name: "evidenceBudget",
              type: "number",
              description: "证据字符预算，1000 到 100000",
              required: false,
              defaultValue: 24000,
            },
            {
              name: "output",
              type: "string",
              description: "brief、report 或 comparison",
              required: false,
              defaultValue: "report",
            },
          ],
  ...
  async research(
    ...
    return {
      ...
      executionMetadata: {
        ...
        sources:
          task.result?.citations.map((citation) => ({
