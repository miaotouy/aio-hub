import { UserCircle, Bot, Zap, Settings2, Wrench, Variable, Sparkles } from "lucide-vue-next";
...
export const agentEditTabs: AgentEditTab[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: "environmentEnhancement",
        label: "环境增强 (Context)",
        keywords: "context environment extension 环境 增强 上下文 插件",
      },
    ],
  },
  {
