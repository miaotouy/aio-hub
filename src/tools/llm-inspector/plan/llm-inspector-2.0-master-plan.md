...
- [ ] A1. hookRegistry 钩子注册器与事件契约
- [ ] A2. messageParser 请求/响应消息块解析器
- [ ] A3. tokenEstimator 客户端估算与服务端 usage 提取

### Group B — 钩子注入

- [ ] B1. LlmRequestOptions 加 inspectorContext 字段
- [ ] B2. fetchWithTimeout 注入钩子触发点
- [ ] B3. useLlmRequest 透传 inspectorContext
- [ ] B4.a. llm-chat 标注 toolName
- [ ] B4.b. translator 标注 toolName
- [ ] B4.c. vcp-connector 标注 toolName
- [ ] B4.d. 其他 LLM 消费者（按需）
