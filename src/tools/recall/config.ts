...
import { Cpu, Database, Zap, Tag, FileUp } from "lucide-vue-next";
import { h } from "vue";
...
export const knowledgeSettingsConfig: SettingsSection<WorkspaceConfig>[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: "dimension 维度 向量长度 size",
      ...
      },
      {
        ...
        keywords: "embedding cache 向量 缓存 容量 memory",
      },
      {
        ...
        keywords: "concurrent 并发 请求 thread",
        groupCollapsible: { name: "embeddingAdvanced", title: "高级请求参数" },
      },
      {
        id: "requestBatchSize",
        label:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: "retrieval cache 检索 缓存 容量 lru",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: "import extract title 导入 提取 标题 markdown",
      },
      {
        ...
        keywords: "import deduplicate 导入 去重 duplicate",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        keywords: "tag generation ai 标签 生成 enable",
      },
      {
        id: "tagGenModel",
        label: "生成模型",
      ...
      },
      {
        ...
        keywords: "tag prompt 标签 提示词 system",
        visible: (settings) => settings.tagGeneration.enabled,
      },
      {
        ...
        hint: "控制生成结果的随机性",
        keywords: "tag temperature 标签 温度 random",
        visible: (settings) => settings.tagGeneration.enabled,
      },
      {
