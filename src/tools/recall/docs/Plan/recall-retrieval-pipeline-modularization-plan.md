...
| Phase 5      | service、Chat、Agent tool、Agent 配置及全局/绑定预设已使用 `presetId`；Agent 编辑器已由 preset summary 和 compile result 驱动 override 范围与能力预检。 | 完成全局模型代际、Playground、Monitor 和 workspace 收口。  |
