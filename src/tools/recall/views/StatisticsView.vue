    ...
    <div class="monitor-container" :class="{ 'is-mobile': isMobile }">
          ...
          <div class="stats-list">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <div class="stat-label">思绪集总数</div>
      ...
      <main class="main-content">
        ...
        <section class="monitor-section">
          <div class="section-title">思绪集详情统计</div>
          <div class="recall-stats-list">
            <div
              v-for="base in store.bases"
              :key="base.id"
              class="recall-stat-card"
            >
              <div class="recall-info">
                <div class="recall-name-row">
                  <Database :size="16" class="recall-icon" />
                  <span class="recall-name">{{ base.name }}</span>
                </div>
