    ...
    <el-card class="left-panel" shadow="never">
      ...
      <div class="preset-section">
        ...
        <div class="preset-actions">
          ...
          <el-button :icon="CopyDocument" @click="handleDuplicatePreset" size="small" :disabled="!store.activePresetId">复制</el-button>
          <el-button @click="handleRenamePreset" size="small" :disabled="!store.activePresetId">重命名</el-button>
          <el-button :icon="Delete" @click="handleDeletePreset" size="small" :disabled="!store.activePresetId || store.presets.length <= 1">删除</el-button>
        </div>
      ...
      <div class="rules-section">
        <div class="rules-header">
          <span class="section-title">规则列表 ({{ currentRules.length }})</span>
          <el-button :icon="Plus" @click="handleAddRule" type="primary" size="small">添加规则</el-button>
        </div>

        <div class="rules-list-container">
          <el-scrollbar v-if="currentRules.length > 0" height="100%">
            <VueDraggableNext
              v-model="localRules"
              item-key="id"
            ...
            >
              ...
              >
                ...
                <el-button
                  :icon="Delete"
                  @click.stop="handleRemoveRule(index)"
                  text
                  circle
                  size="small"
          ...
          <el-empty v-else description="暂无规则，点击'添加规则'按钮创建" />
        </div>
      </div>
    </el-card>
...
watch(() => store.activePreset, (newPreset) => {
