...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; padding: 20px; background: var(--bg-color); border: var(--border-width) solid var(--border-color); border-radius: 8px;">
  <div style="padding: 20px; background: var(--container-bg); border: var(--border-width) solid var(--border-color); border-radius: 8px;">
    <strong>容器背景</strong><br>
    <code style="font-size: 12px">var(--container-bg)</code>
  </div>
  <div style="padding: 20px; background: var(--card-bg); border: var(--border-width) solid var(--border-color); border-radius: 8px;">
    <strong>卡片背景</strong><br>
    <code style="font-size: 12px">var(--card-bg)</code>
  </div>
  <div style="padding: 20px; background: var(--sidebar-bg); border: var(--border-width) solid var(--border-color); border-radius: 8px; color: var(--text-color);">
    <strong>侧边栏背景</strong><br>
    <code style="font-size: 12px">var(--sidebar-bg)</code>
  </div>
  <div style="padding: 20px; background: var(--input-bg); border: var(--border-width) solid var(--border-color); border-radius: 8px;">
...
<div style="display: flex; gap: 20px; align-items: center; flex-wrap: wrap;">
  <div style="width: 80px; height: 80px; border: var(--border-width) solid var(--border-color); display: flex; align-items: center; justify-content: center; background: var(--card-bg);">基础</div>
  ...
  <div style="width: 80px; height: 80px; border: var(--border-width) solid var(--border-color); border-radius: var(--radius-small); display: flex; align-items: center; justify-content: center; background: var(--card-bg);">小圆角</div>
  <div style="width: 80px; height: 80px; border: var(--border-width) solid var(--border-color); border-radius: var(--radius-base); display: flex; align-items: center; justify-content: center; background: var(--card-bg);">基础圆角</div>
  <div style="width: 80px; height: 80px; border: var(--border-width) solid var(--border-color); border-radius: var(--radius-round); display: flex; align-items: center; justify-content: center; background: var(--card-bg);">圆形圆角</div>
</div>
