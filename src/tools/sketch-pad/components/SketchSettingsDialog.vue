        ...
        <el-form label-position="top" class="settings-form">
          ...
          <div class="settings-section">
            ...
            <el-form-item label="默认比例预设">
              <el-select
                v-model="local.defaultCanvasPreset"
          ...
          <div class="settings-section">
            ...
            <el-form-item label="默认大小">
              <el-slider
                v-model="local.defaultBrushSize"
                :min="1"
                :max="100"
                :step="1"
                show-input
            ...
            <el-form-item label="默认颜色">
              <el-color-picker
                v-model="local.defaultBrushColor"
            ...
            <el-form-item label="默认透明度">
              <el-slider
                v-model="local.defaultBrushOpacity"
                :min="0"
                :max="1"
                :step="0.05"
                show-input
          ...
          <div class="settings-section">
            ...
            <el-form-item label="描边宽度">
              <el-slider
                v-model="local.defaultStrokeWidth"
                :min="1"
                :max="20"
                :step="1"
                show-input
            ...
            <el-form-item label="描边颜色">
              <el-color-picker
                v-model="local.defaultStrokeColor"
                :predefine="PRESET_COLORS"
              />
            </el-form-item>
            ...
            <el-form-item label="填充颜色">
              <div class="color-row">
                ...
                />
                <el-button
                  v-if="local.defaultFillColor"
                  text
                  size="small"
                  @click="local.defaultFillColor = null"
                >
                  无填充
                </el-button>
                <span class="color-hint">{{
                  local.defaultFillColor || "无填充"
                }}</span>
              </div>
            </el-form-item>
            ...
            <el-form-item label="圆角半径">
              <el-slider
                v-model="local.defaultCornerRadius"
                :min="0"
                :max="50"
                :step="1"
                show-input
          ...
          <div class="settings-section">
            ...
            <el-form-item label="默认颜色">
              <el-color-picker
                v-model="local.defaultTextColor"
                :predefine="PRESET_COLORS"
              />
            </el-form-item>
          </div>
...
} from "../composables/useSketchSettings";
