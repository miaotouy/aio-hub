  ...
  [
    {
      ...
      items: [
        ...
        },
        {
          ...
          label:
            "连续重复阈值 ({{ localSettings.repetitionConfig.consecutiveThreshold }}次)",
        ...
        },
        {
          ...
          label:
            "全局片段阈值 ({{ localSettings.repetitionConfig.globalThreshold }}次)",
          component: "SliderWithInput",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label:
            "宽高比阈值 ({{ localSettings.imageSlicerConfig.aspectRatioThreshold }}:1)",
          component: "SliderWithInput",
        ...
        },
        {
          id: "minCutHeight",
          label:
            "最小切片高度 ({{ localSettings.imageSlicerConfig.minCutHeight }}px)",
          component: "SliderWithInput",
