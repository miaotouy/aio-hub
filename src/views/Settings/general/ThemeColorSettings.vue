...
const getCurrentColor = (type: ColorType): string => {
  switch (type) {
    case "primary":
      return themeColor.value || "#409eff";
    case "success":
      return successColor.value || "#67c23a";
    case "warning":
      return warningColor.value || "#e6a23c";
    case "danger":
      return dangerColor.value || "#f56c6c";
    case "info":
      return infoColor.value || "#909399";
  }
};
